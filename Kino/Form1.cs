...
namespace Kino
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\roof1\OneDrive\Desktop\Kino\Kino\AppData\kino.mdf;Integrated Security=True");
        ...
        public Form1()
        {
            ...
            for (int i = 0; i < b; i++)
            {
                ...
                films = new PictureBox()
                {
                    ...
                    Image = System.Drawing.Image.FromFile(@"C:\Users\roof1\OneDrive\Desktop\Kino\Kino\Pictures\" + listofpilt[i]),
